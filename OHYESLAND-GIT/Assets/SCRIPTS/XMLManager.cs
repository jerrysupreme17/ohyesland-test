...
public class XMLManager : MonoBehaviour
{
    ...
    public void SaveScores(List<HIGHSCORE_ENTRY> scoresToSave)
    {
    ...
    public List<HIGHSCORE_ENTRY> LoadScores()
    {
...
{
    public List<HIGHSCORE_ENTRY> list = new List<HIGHSCORE_ENTRY>();
}
